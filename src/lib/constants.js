...
export const FEATURES = [
    { img: im1, title: 'Eliminate Errors', content: 'Efficiently and rapidly allocate precise and high-quality assignments in a matter of seconds.' },
    { img: im2, title: 'Save Time & Money', content: 'Streamline your registration, processing, and allotment, saving time and enhancing delegate satisfaction.' },
    { img: im3, title: 'Best Delegate Experience', content: 'Allotrix allows delegates to select their desired countries for a more engaging debate experience.' },
    { img: im4, title: 'Get Insights', content: 'Allotrix provides detailed insights into your tournament data, so you can make informed decisions about future events.' },
]
